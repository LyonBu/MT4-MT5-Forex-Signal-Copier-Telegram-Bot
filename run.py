...
# allowed FX symbols
SYMBOLS = ['ADAUSD', 'ADAUSDZ', 'ADAUSDz', 'ADAUSD.z', 'BTCUSD', 'BTCUSDZ', 'BTCUSDz', 'BTCUSD.z', 'AUDCAD', 'AUDCADZ', 'AUDCHF', 'AUDJPY', 'AUDNZD', 'AUDUSD', 'CADCHF', 'CADJPY', 'CHFJPY', 'EURAUD', 'EURCAD', 'EURCHF', 'EURGBP', 'EURJPY', 'EURNZD', 'EURUSD', 'GBPAUD', 'GBPCAD', 'GBPCHF', 'GBPJPY', 'GBPNZD', 'GBPUSD', 'NOW', 'NZDCAD', 'NZDCHF', 'NZDJPY', 'NZDUSD', 'USDCAD', 'USDCHF', 'USDJPY', 'XAGUSD', 'XAUUSD']
